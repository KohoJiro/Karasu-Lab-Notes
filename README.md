...
* **Status:** **Active Lifecycle Reassignment.** Hardware reassigned to a headless role following a display assembly failure (persistent purple hue isolated to internal LCD). 
